	...
	<form id="new_write" action="new_writeAction.jsp" method="post">
	    <div class="container">
	        ...
	        <div class="write-title">
				<input class="write-title-title" name="title" type="text" placeholder="제목을 입력해 주세요.">
	        </div>
	       	<div>
	       		카테고리
	        ...
	        <div class="wirte-btn">
	            ...
	            <div class="wirte-upload"><a href="javascript:{}" onclick="document.getElementById('new_write').submit();">등록</a></div>
	        </div>
	    </div>
    </form>
